    ...
    return(
        ...
        >
          <div className="grid grid-cols-2 gap-1">
            ...
            />
            <button className={`flex-grow ${moreFieldsToggle? 'hidden' : ''} max-w-max px-2 bg-border-light rounded-lg text-darktext`}>
              Add Task
            </button>
          </div>
          <div className="flex flex-col gap-2 pt-1">
            <div className={`${moreFieldsToggle? '' : 'hidden'} grid grid-cols-2 gap-2`}>
              <input
