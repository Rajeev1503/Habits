  ...
  return (
    <Layout title='Signin'>
      ...
      <div className="text-lighttext mb-8 flex flex-col gap-2 items-center">
       <div className="text-center"><FaList size={40}/></div> 
      <h1 className="">Signin To Taskify</h1>
      </div>
    <div className="text-lighttext font-semibold  p-4 rounded-lg">
      <div className="flex flex-col gap-8">
        <form className="flex flex-col w-full gap-4" action="/api/user" method="POST" onSubmit={onSubmitHandler}>
          <br></br>
          <Input
          id="usernameoremail"
          element="input"
        ...
        <Input
          ...
          onInput={inputHandler}
        />
        <Button type="submit" className="submit" disabled={!formState.isValid}>
          Login
        </Button>
        ...
        <div className="quick-signin-wrapper flex flex-col gap-2">
          <div className="w-full bg-lighttext text-darktext flex gap-2 justify-center items-center p-1 rounded-lg text-xs"><span className="max-w-max"><FaGithub size={20}/></span><span className="max-w-max">Login Using Github</span></div>
          <div className="w-full bg-lighttext text-darktext flex gap-2 justify-center items-center p-1 rounded-lg text-xs"><span className="max-w-max"><FaGoogle size={20}/></span><span className="max-w-max">Login Using Google</span></div>
        </div>
